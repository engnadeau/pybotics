    ...
    for r in angles:
        for p in angles:
            for w in angles:
                ...
                pose_original = geometry.euler_zyx_2_frame(xyzrpw_original)

                xyzrpw_result = geometry.frame_2_euler_zyx(pose_original)
                pose_result = geometry.euler_zyx_2_frame(xyzrpw_result)
